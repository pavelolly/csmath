...
main.exe: main.c tokenizer.c libcontainers.a
...
${CONTAINERS_DIR}/tree.c ${CONTAINERS_DIR}/tree.h
	...
	${CC} -O3 -o ${CONTAINERS_DIR}/tree.o -c ${CONTAINERS_DIR}/tree.c
	ar rcs lib\libcontainers.a ${CONTAINERS_DIR}\array.o ${CONTAINERS_DIR}\string.o ${CONTAINERS_DIR}\tree.o
	${RM} ${CONTAINERS_DIR}/*.o
